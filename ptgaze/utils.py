...
def _expanduser_all(config: yacs.config.CfgNode) -> None:
    config.face_detector.dlib.model = _expanduser(config.face_detector.dlib.model)
...
def update_default_config(config: yacs.config.CfgNode, args: argparse.Namespace) -> None:
